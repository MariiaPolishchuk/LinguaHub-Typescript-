...
import { Button, Dialog, DialogActions, DialogContent, DialogTitle, IconButton, List, ListItem, ListItemText, ListItemSecondaryAction, TextField } from "@mui/material";
                ...
                {lessons.map((lesson) => (
                    <ListItem key={lesson.id}>
                        ...
                        <ListItemSecondaryAction>
                            <IconButton onClick={() => handleEditLesson(lesson)} aria-label="edit">
                                Edit
                            </IconButton>
                            <IconButton onClick={() => handleDeleteLesson(lesson)} aria-label="delete">
                                <DeleteIcon />
                            </IconButton>
                        </ListItemSecondaryAction>
                    </ListItem>
